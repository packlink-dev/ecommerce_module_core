...
class SubscriptionController
{
     ...
     */
    const GENERIC_BANNER_LABEL = 'Unlock exclusive shipping benefits with access to the best carrier rates, premium refrigerated delivery services, and the freedom to ship using your own negotiated carrier rates.';
